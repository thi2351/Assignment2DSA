...
xmap<string, TensorDataset<double, double>*>* DSFactory::get_datasets_3cc(){
    xmap<string,TensorDataset<double,double>*>* ThisAssignementforcemetodead = new xmap<string, TensorDataset<double, double>*>(
            &stringHash,
            0.75, //load-factor
            0, //value-comparator: use ==
            xmap<string, TensorDataset<double, double>*>::freeValue);
    return ThisAssignementforcemetodead;
}
...
xmap<string, TensorDataset<double, double>*>* DSFactory::get_datasets_2cc(){
    ...
    // cout << shape2str(train_table.shape());
